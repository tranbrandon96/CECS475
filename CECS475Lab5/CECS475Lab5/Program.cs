...
// Date: 3/29/2020
// Lab Assignment 5: Stocks using Async/Synchronization implementation
...
namespace CECS475Lab5
{
    class Program
    {
        ...
        public class StockBroker
        {
            ...
            string path = "/Users/brandontran/Projects/CECS475Lab5/stocks.txt";
            public static ReaderWriterLockSlim newSync = new ReaderWriterLockSlim();
            ...
            {
                string header;
                String outBrokerName = brokerName.ToString();
                String outStockName = e._stockName.ToString();
                String outCurrentValueOfStock = e._currentValueOfStock.ToString();
                String outNumOfChanges = e._numOfChanges.ToString();

                header = outBrokerName.PadRight(12) + outStockName.PadRight(12) + outCurrentValueOfStock.PadRight(12) + outNumOfChanges.PadRight(12) + DateTime.Now;
                newSync.EnterWriteLock();
